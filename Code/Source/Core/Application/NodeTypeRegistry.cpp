...
namespace GOAT
{
    ...
    {
        // Only the words every paradigm reads. What a tree is written in -- selectors, decorators,
        // services -- belongs to the backend that gives them meaning, and arrives with it.
        ...
        auto condition = Simple("condition", NodeKind::Leaf, NodeOp::Condition, "Leaf",
            "Checks a blackboard value, and aborts the branch it sits in when that value changes");
        ...
        auto compare = Simple("compare", NodeKind::Leaf, NodeOp::Compare, "Leaf",
            "Compares two blackboard values, and aborts the branch it sits in when either changes");
        ...
        auto delegate = Simple("delegate", NodeKind::Leaf, NodeOp::Delegate, "Leaf",
