...
namespace GOAT
{
    ...
    void GOATDirectorComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        editContext->Class<GOATDirectorComponent>("GOAT Director",
            "Reshapes what the other agents are doing. Governs them all until a filter component narrows it.")
    ...
    void GOATDirectorComponent::Activate()
    {
        ...
        if (agents == nullptr || !agents->RegisterDirector(m_agent, profile))
        {
            return;
        }
